...
<p align="center">
  <img src="https://raw.githubusercontent.com/bubablue/system-performance-extension/master/assets/SystemPerformanceDemo.gif" alt="Demo" width="800"/>
</p>
...
### Method 3: VSIX File
Download the latest `.vsix` file from [releases](https://github.com/bubablue/system-performance-extension/releases) and install manually.
...
1. **🐛 Report Bugs** - Found an issue? [Open an issue](https://github.com/bubablue/system-performance-extension/issues)
